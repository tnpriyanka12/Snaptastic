...
class SnapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snap" do
    assert_difference('Snap.count') do
      post snaps_url, params: { snap: { snap: @snap.snap, snap_name: @snap.snap_name, user_id: @snap.user_id } }
    end
  ...
  test "should update snap" do
    patch snap_url(@snap), params: { snap: { snap: @snap.snap, snap_name: @snap.snap_name, user_id: @snap.user_id } }
